...
class OrderResource extends Resource
{
    ...
    /**
     * After State: https://filamentphp.com/docs/3.x/forms/advanced#field-updates
    */
    public static function getCustomerFormDetails(): array
    {
        //dd("2 - getCustomerFormDetails");
        return [
            Grid::make(3)->schema([
                    Section::make()
                        ->schema([
                            ...
                            Placeholder::make('total')
                                ...
                                ->content(function ($get) {
                                    ...
                                    return new HtmlString(
                                        view(view: 'orders.latest-orders', data: static::getSelectedCustomer($get('customer_id'),))->render()
                                    );
                                }),
                        ])
                        ->columnSpan(1)
    ...
    public static function getPaymentFormDetails(array $data): array
    {
        return [
            Grid::make(3)
                ->schema([
